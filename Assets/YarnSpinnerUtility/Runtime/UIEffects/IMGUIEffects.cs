...
namespace YarnSpinnerUtility.Runtime.UIEffects
{
    public static class IMGUIEffects
    {
        ...
        /// </summary>
        public static async Awaitable FadeAlpha(CanvasGroup canvasGroup, float from, float to, float duration, CancellationToken cancellationToken = default)
        {
